...
class Test(unittest.TestCase):
    ...
    # throws exception after adding new features
    # currentPOS
    # previousPOS
    # nextPOS
    ...
    def testExtractFeatures(self):
        sentences = Tagger.readCoNLL(self.filename)
        s = sentences[0]
    ...
    def testReadFromFile(self):
        ss = Tagger.readCoNLL("H:\\Uni\\Winter Semester 2022 2023\\Projekt _Seminar\\Data\\tiger-2.2.train.conll09")
        fes = FeatureExtractors()
        fes.extractAllFeatures(ss)
        fes.writeToFile(ss, "H:\\Uni\\Winter Semester 2022 2023\\Projekt _Seminar\\Data\\file-tiger.svmmulti")
        ss = FeatureExtractors.readFromFile("H:\\Uni\\Winter Semester 2022 2023\\Projekt _Seminar\\Data\\file-tiger.svmmulti")
